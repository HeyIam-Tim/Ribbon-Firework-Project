...
from .views import RibbonList, RegisterPage, RibbonLoginView, OrderInfoCreate, OrderInfoList, OrderInfoDetail, RibbonListApi
from django.contrib.auth.views import LogoutView

urlpatterns = [
    # path('', RibbonList.as_view(), name='index'),
    path('', RibbonList.as_view(), name='index'),
    path('api/', RibbonListApi.as_view(), name='api'),
